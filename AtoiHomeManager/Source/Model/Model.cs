...
namespace AtoiHomeManager
{
    public partial class App : Application
    {
        ...
        // App에서 처리하기 위해 추가됨
        // 이벤트 라우트 경로
        // TextTrasnferService.UploadImage -> Service Application -> NotifyServer -> Application.callback -> Application.TextTransferEventHandler -> ViewModelEventHandler -> View
        //                                                                        |  
        //                                                                        |
        //                                                          Service side    Client side
        // 복잡해진 듯 하지만 경계는 확실하다.

        private void TextTransferEventHandler(Object sender, TextTransferEventArgs e)
        {
            try
            {
                ...
                {
                    //IPC서버가 TextTransfer.UploadImage에서 발행한  이벤트에 포함된 업로드파일명을 라우트하여 전달
